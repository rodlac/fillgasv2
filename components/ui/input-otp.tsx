...
>(({ index, className, ...props }, ref) => (
  <Slot
    ...
    index={index}
    className={cn(
      "relative flex h-9 w-9 items-center justify-center border-y border-r border-input text-sm shadow-sm transition-all first:rounded-l-md first:border-l last:rounded-r-md focus:z-10 focus:outline-none focus:ring-1 focus:ring-ring data-[selected]:bg-accent data-[state=active]:bg-accent data-[state=active]:ring-1 data-[state=active]:ring-ring",
      className,
    )}
    {...props}
  />
